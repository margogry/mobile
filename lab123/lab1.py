...
def tarific1():
    inputData()
    who = '915783624' #input('ведите номер абонента - ')
    outRing = 2 #input('Сколько для него стоят исходящие звонки? - ')
    inRing = 0 #input('Сколько стоят входящие звонки? - ')
    freeSMS = 10 #input('Сколько бесплатных СМС? - ')
    costSMS = 1 #input('Сколько стоят последующие СМС? - ')
    res = 0
...
#print('Тарификация услуг - ', tarific1())
